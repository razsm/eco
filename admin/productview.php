...
$result = mysqli_query($mysqli, "SELECT p.prod_image as prod_image, p.id as id, p.name as product_name, c.maincat_id as maincat_id,c.id as category_id,code ,price FROM product as p LEFT JOIN category as c on c.id = p.category_id");
