...
if(isset($_POST['Submit'])  && isset($_FILES) ) {
    ...
    if($name == "" || $code == "" || $price == "" || $maincat_id == "" || $category_id == "" ) {
...
//            		$prod_image =  $target_file;
            $prod_image = "img/" . $catArray[ (int) $_POST['maincat_id']  ]  . "/" .  basename($_FILES["image"]["name"]);
            //echo "  prod_image :::: " .  $prod_image ;
        } else {
		  $prod_image = "";
        }
	
        $sql = "INSERT INTO product(name, maincat_id, category_id , code , price , prod_image) VALUES('$name', '$maincat_id','$category_id' , '$code','$price', '$prod_image')";      
...
//        echo " sql:: " .  $sql;
        ...
        echo "<h3> Product added : " . $result  . "</h3>";
